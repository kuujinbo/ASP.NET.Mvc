...
namespace System.Web.Mvc
{
    ...
    {
        public static MvcHtmlString SimpleFileUpload(this HtmlHelper helper)
        {
...
<div class='input-group'>
    <span class='input-group-btn'>
        <label class='btn btn-success' type='button'>
            <input id='simpleFileUpload' name='simpleFileUpload' type='file' onchange='fileUpload(this)' style='display:none;'>Browse....
        </label>
    </span>
